...
const create = (config) => {
  ...
  app.getConfig = () => { return config.app || {}; };
  app.getMasterConfig = () => { return config; };
  app.getExpressApp = () => { return expressApp; };
  app.getExpressServer = () => { return expressServer; };
  ...
  app.auth = require('./auth')(config.auth || {});
